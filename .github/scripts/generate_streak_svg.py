...
def generate_smart_svg(current, longest, total, longest_range, start_date_obj):
    ...
    dwg = svgwrite.Drawing('assets/Streaks/streak-smart.svg', size=('495px', '195px'), viewBox='0 0 495 195')

    # CSS Styles with Media Query
    css_styles = f"""
    ...
    main.add(dwg.text(lifetime_label, insert=(82.5, 146), text_anchor='middle', class_="text-range",
    ...
    ring_g.add(dwg.circle(center=(247.5, 71), r=40, fill='none', stroke_width=5, class_="ring",
    ...
    main.add(dwg.text(longest_range, insert=(412.5, 146), text_anchor='middle', class_="text-range",
                      style='opacity: 0; animation: fadein 0.5s linear forwards 1.4s'))

    # Save
    os.makedirs('assets/Streaks', exist_ok=True)
    dwg.save()
    print("Saved: assets/Streaks/streak-smart.svg")
...
if __name__ == '__main__':
    ...
    generate_smart_svg(current, longest, total, longest_range, created_at_date)
    print("Done!")
