...
def generate_svg(current, longest, total, username, longest_range, theme_slug):
    ...
    total_g.add(dwg.text(str(total), insert=(0, 32), fill=colors['accent'], font_family='"Segoe UI", Ubuntu, sans-serif',
    ...
    label_g.add(dwg.text('Total Contributions', insert=(0, 32), fill=colors['label'], font_family='"Segoe UI", Ubuntu, sans-serif',
    ...
    range_g.add(dwg.text('May 9, 2019 - Present', insert=(0, 32), fill=colors['range'], font_family='"Segoe UI", Ubuntu, sans-serif',
    ...
    center_g.add(dwg.text('Current Streak', insert=(0, 32), fill=colors['current'], font_family='"Segoe UI", Ubuntu, sans-serif',
    ...
    ring_g.add(dwg.circle(center=(247.5, 71), r=40, fill='none', stroke=colors['accent'], stroke_width=5,
    ...
    curr_num_g.add(dwg.text(str(current), insert=(0, 32), fill=colors['current'], font_family='"Segoe UI", Ubuntu, sans-serif',
                            font_size=28, font_weight=700, text_anchor='middle',
    ...
    long_g.add(dwg.text(str(longest), insert=(0, 32), fill=colors['accent'], font_family='"Segoe UI", Ubuntu, sans-serif',
                        font_size=28, font_weight=700, text_anchor='middle',
                        style='opacity: 0; animation: fadein 0.5s linear forwards 1.2s'))
    main.add(long_g)

    long_label = dwg.g(transform='translate(412.5, 84)')
    long_label.add(dwg.text('Longest Streak', insert=(0, 32), fill=colors['label'], font_family='"Segoe UI", Ubuntu, sans-serif',
                            font_size=14, text_anchor='middle',
                            style='opacity: 0; animation: fadein 0.5s linear forwards 1.3s'))
    main.add(long_label)

    long_range_g = dwg.g(transform='translate(412.5, 114)')
    long_range_g.add(dwg.text(longest_range, insert=(0, 32), fill=colors['range'], font_family='"Segoe UI", Ubuntu, sans-serif',
                              font_size=12, text_anchor='middle',
                              style='opacity: 0; animation: fadein 0.5s linear forwards 1.4s'))
    main.add(long_range_g)

    # Save directly to final filename (no mv needed)
